...
llvm_cbe_tmp__64:
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = phi i64 [ %%41, %%37 ], [ 0, %%.preheader  for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_106_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ %%42, %%37 ], [ 0, %%.preheader  for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
llvm_cbe_tmp__68:
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = mul nsw i32 %%storemerge1, 100, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_126_count);
  llvm_cbe_tmp__45 = (unsigned int )((unsigned int )(llvm_cbe_storemerge1&4294967295ull)) * ((unsigned int )(100u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__45&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = sext i32 %%38 to i64, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_127_count);
  llvm_cbe_tmp__46 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__45);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = getelementptr inbounds [1000001 x i2]* @ref_genome, i64 0, i64 %%39, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_128_count);
  llvm_cbe_tmp__47 = ( char *)(&ref_genome[(((signed long long )llvm_cbe_tmp__46))
#ifdef AESL_BC_SIM
 % 1000001
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @copy_base_pairs(i2* %%40, i8* %%20, i32 100), !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_129_count);
  copy_base_pairs(( char *)llvm_cbe_tmp__47, ( char *)llvm_cbe_tmp__34, 100u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",100u);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = add i64 %%26, 100, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_130_count);
  llvm_cbe_tmp__48 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__38&18446744073709551615ull)) + ((unsigned long long )(100ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__48&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = add nsw i32 %%storemerge1, 1, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_135_count);
  llvm_cbe_tmp__49 = (unsigned int )((unsigned int )(llvm_cbe_storemerge1&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__49&4294967295ull)));
  llvm_cbe_tmp__38__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__48;   /* for PHI node */
  llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__49;   /* for PHI node */
  goto llvm_cbe_tmp__64;

llvm_cbe_tmp__66:
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i8* @fgets(i8* %%20, i32 200, %%struct._iobuf* %%59) nounwind, !dbg !9 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_116_count);
  ( char *)fgets(( char *)llvm_cbe_tmp__34, 200u, (l_struct_OC__iobuf *)llvm_cbe_tmp__62);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",200u);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__39);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i64 @strlen(i8* %%20) nounwind, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__40 = (unsigned long long )strlen(( char *)llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__40);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = add i64 %%26, -1, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_118_count);
  llvm_cbe_tmp__41 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__38&18446744073709551615ull)) + ((unsigned long long )(18446744073709551615ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__41&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = add i64 %%31, %%30, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_119_count);
...
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__42&18446744073709551615ull)));
  if ((((unsigned long long )llvm_cbe_tmp__42&18446744073709551615ULL) > ((unsigned long long )1000000ull&18446744073709551615ULL))) {
...
llvm_cbe_tmp__69:
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = add i64 %%30, -1, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_122_count);
  llvm_cbe_tmp__43 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__40&18446744073709551615ull)) + ((unsigned long long )(18446744073709551615ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__43&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([62 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32 %%storemerge1, i64 %%26, i64 %%35) nounwind, !dbg !11 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_123_count);
  printf(( char *)((&aesl_internal__OC_str6[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 62
#endif
])), llvm_cbe_storemerge1, llvm_cbe_tmp__38, llvm_cbe_tmp__43);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__67:
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = call i32 @fclose(%%struct._iobuf* %%59) nounwind, !dbg !9 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_138_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__62);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = call i8* @fgets(i8* %%5, i32 200, %%struct._iobuf* %%3) nounwind, !dbg !8 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_140_count);
  ( char *)fgets(( char *)llvm_cbe_tmp__23, 200u, (l_struct_OC__iobuf *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",200u);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = load i8* %%5, align 16, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_141_count);
  llvm_cbe_tmp__52 = (unsigned char )*llvm_cbe_tmp__23;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__52);
  if (((llvm_cbe_tmp__52&255U) == (((unsigned char )64)&255U))) {
    goto llvm_cbe__2e__crit_edge_2e_1;
  } else {
    goto llvm_cbe__2e_lr_2e_ph_2e_1;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = call i8* @fgets(i8* %%5, i32 200, %%struct._iobuf* %%3) nounwind, !dbg !8 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_144_count);
  ( char *)fgets(( char *)llvm_cbe_tmp__23, 200u, (l_struct_OC__iobuf *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",200u);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = load i8* %%5, align 16, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_155_count);
  llvm_cbe_tmp__55 = (unsigned char )*llvm_cbe_tmp__23;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__55);
  if (((llvm_cbe_tmp__55&255U) == (((unsigned char )64)&255U))) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = call i8* @fgets(i8* %%5, i32 200, %%struct._iobuf* %%3) nounwind, !dbg !8 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_158_count);
  ( char *)fgets(( char *)llvm_cbe_tmp__23, 200u, (l_struct_OC__iobuf *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",200u);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = load i8* %%5, align 16, !dbg !10 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_159_count);
  llvm_cbe_tmp__57 = (unsigned char )*llvm_cbe_tmp__23;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__57);
  if (((llvm_cbe_tmp__57&255U) == (((unsigned char )64)&255U))) {
    goto llvm_cbe__2e__crit_edge_2e_2;
  } else {
    goto llvm_cbe__2e_lr_2e_ph_2e_2;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = call i8* @fgets(i8* %%5, i32 200, %%struct._iobuf* %%3) nounwind, !dbg !8 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_162_count);
  ( char *)fgets(( char *)llvm_cbe_tmp__23, 200u, (l_struct_OC__iobuf *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",200u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = call i32 @fclose(%%struct._iobuf* %%3) nounwind, !dbg !8 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_172_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__59);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = call i32* @_errno() nounwind, !dbg !12 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_173_count);
  llvm_cbe_tmp__60 = (signed int *)_errno();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__60);
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* %%57, align 4, !dbg !12 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_174_count);
  *llvm_cbe_tmp__60 = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  %%58 = load i8** @genome_file, align 8, !dbg !12 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_175_count);
  llvm_cbe_tmp__61 = ( char *)*(&genome_file);
if (AESL_DEBUG_TRACE)
printf("\n  %%59 = call %%struct._iobuf* @fopen(i8* %%58, i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str3, i64 0, i64 0)) nounwind, !dbg !12 for 0x%I64xth hint within @init  --> \n", ++aesl_llvm_cbe_176_count);
  llvm_cbe_tmp__62 = (l_struct_OC__iobuf *)aesl_fopen(( char *)llvm_cbe_tmp__61, ( char *)((&aesl_internal__OC_str3[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 2
#endif
])));
...
printf("\n  %%1 = tail call i32 bitcast (i32 (...)* @needlemanWunsch to i32 (i2*, i2*)*)(i2* getelementptr inbounds ([3 x [101 x i2]]* @reads, i64 0, i64 0, i64 0), i2* getelementptr inbounds ([1000001 x i2]* @ref_genome, i64 0, i64 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_196_count);
  llvm_cbe_tmp__70 = (unsigned int ) /*tail*/ needlemanWunsch(( char *)((&reads[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
][(((signed long long )0ull))
...
printf("\n  %%2 = trunc i32 %%1 to i20, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_197_count);
  llvm_cbe_tmp__71 = (unsigned int )((unsigned int )llvm_cbe_tmp__70&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__71);
if (AESL_DEBUG_TRACE)
printf("\n  store i20 %%2, i20* getelementptr inbounds ([3 x i20]* @best_fits, i64 0, i64 0), align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_198_count);
 ...
 % 3
#endif
])) = ((llvm_cbe_tmp__71) & 1048575ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__71);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = zext i20 %%2 to i32, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_199_count);
  llvm_cbe_tmp__72 = (unsigned int )((unsigned int )(unsigned int )llvm_cbe_tmp__71&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__72);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%5 = tail call i32 bitcast (i32 (...)* @needlemanWunsch to i32 (i2*, i2*)*)(i2* getelementptr inbounds ([3 x [101 x i2]]* @reads, i64 0, i64 1, i64 0), i2* getelementptr inbounds ([1000001 x i2]* @ref_genome, i64 0, i64 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_208_count);
  llvm_cbe_tmp__74 = (unsigned int ) /*tail*/ needlemanWunsch(( char *)((&reads[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 3
#endif
][(((signed long long )0ull))
...
printf("\n  %%6 = trunc i32 %%5 to i20, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_209_count);
  llvm_cbe_tmp__75 = (unsigned int )((unsigned int )llvm_cbe_tmp__74&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__75);
if (AESL_DEBUG_TRACE)
printf("\n  store i20 %%6, i20* getelementptr inbounds ([3 x i20]* @best_fits, i64 0, i64 1), align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_210_count);
 ...
 % 3
#endif
])) = ((llvm_cbe_tmp__75) & 1048575ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__75);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = zext i20 %%6 to i32, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_211_count);
  llvm_cbe_tmp__76 = (unsigned int )((unsigned int )(unsigned int )llvm_cbe_tmp__75&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__76);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%9 = tail call i32 bitcast (i32 (...)* @needlemanWunsch to i32 (i2*, i2*)*)(i2* getelementptr inbounds ([3 x [101 x i2]]* @reads, i64 0, i64 2, i64 0), i2* getelementptr inbounds ([1000001 x i2]* @ref_genome, i64 0, i64 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_220_count);
  llvm_cbe_tmp__78 = (unsigned int ) /*tail*/ needlemanWunsch(( char *)((&reads[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 3
#endif
][(((signed long long )0ull))
...
printf("\n  %%10 = trunc i32 %%9 to i20, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_221_count);
  llvm_cbe_tmp__79 = (unsigned int )((unsigned int )llvm_cbe_tmp__78&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__79);
if (AESL_DEBUG_TRACE)
printf("\n  store i20 %%10, i20* getelementptr inbounds ([3 x i20]* @best_fits, i64 0, i64 2), align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_222_count);
 ...
 % 3
#endif
])) = ((llvm_cbe_tmp__79) & 1048575ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__79);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = zext i20 %%10 to i32, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_223_count);
  llvm_cbe_tmp__80 = (unsigned int )((unsigned int )(unsigned int )llvm_cbe_tmp__79&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__80);
if (AESL_DEBUG_TRACE)
