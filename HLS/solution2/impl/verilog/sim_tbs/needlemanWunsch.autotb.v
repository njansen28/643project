...
`define AUTOTB_TVIN_read_r  "./c.needlemanWunsch.autotvin_read_r.dat"
`define AUTOTB_TVIN_ref_genome  "./c.needlemanWunsch.autotvin_ref_genome.dat"
`define AUTOTB_TVIN_read_r_out_wrapc  "./rtl.needlemanWunsch.autotvin_read_r.dat"
`define AUTOTB_TVIN_ref_genome_out_wrapc  "./rtl.needlemanWunsch.autotvin_ref_genome.dat"
`define AUTOTB_TVOUT_ap_return  "./c.needlemanWunsch.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.needlemanWunsch.autotvout_ap_return.dat"
...
initial begin : generate_done_cnt_proc
    ...
    @(posedge AESL_clock);
    # 0.4;
    fp1 = $fopen("./rtl.needlemanWunsch.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.needlemanWunsch.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.needlemanWunsch.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.needlemanWunsch.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.needlemanWunsch.autotvout_ap_return.dat with impl_rtl.needlemanWunsch.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
