...
entity needlemanWunsch_AXILiteS_s_axi is
    generic (
...
end entity needlemanWunsch_AXILiteS_s_axi;
...
architecture behave of needlemanWunsch_AXILiteS_s_axi is
    ...
    signal int_ap_return       : UNSIGNED(19 downto 0);
        ...
        if (ACLK'event and ACLK = '1') and ACLK_EN = '1' then
            if (ar_hs = '1') then
                ...
                when ADDR_AP_RETURN_0 =>
                    rdata_data <= RESIZE(int_ap_return(19 downto 0), 32);
                when others =>
                    rdata_data <= (others => '0');
                end case;
            end if;
