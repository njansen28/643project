...
unsigned int AESL_ORIG_DUT_needlemanWunsch( char *llvm_cbe_read,  char *llvm_cbe_ref_genome);
...
printf("\n\{ BEGIN @doRow\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = trunc i32 %%i to i20, !dbg !4 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__1 = (unsigned int )((unsigned int )llvm_cbe_i&1048575U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = add i20 %%1, -1, !dbg !4 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_37_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = trunc i32 %%storemerge10.us to i8, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_101_count);
  llvm_cbe_tmp__8 = (unsigned char )((unsigned char )llvm_cbe_storemerge10_2e_us&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = sub i8 1, %%11, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_102_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond.us = or i1 %%19, %%20, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_or_2e_cond_2e_us_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds i20* %%orig_out, i64 %%15, !dbg !7 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__5 = (signed int *)(&llvm_cbe_orig_out[(((signed long long )llvm_cbe_tmp__11))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__11));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i20 %%storemerge3.us, i20* %%7, align 4, !dbg !7 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_73_count);
  *llvm_cbe_tmp__5 = ((llvm_cbe_storemerge3_2e_us) & 1048575ull);
if (AESL_DEBUG_TRACE)
printf("\nstoremerge3.us = 0x%X\n", llvm_cbe_storemerge3_2e_us);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = add nsw i32 %%storemerge10.us, 1, !dbg !9 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_74_count);
...
llvm_cbe_tmp__46:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond8.us = or i1 %%22, %%23, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_or_2e_cond8_2e_us_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%..us = select i1 %%or.cond8.us, i8 %%phitmp14, i8 %%phitmp12, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe__2e__2e_us_count);
...
printf("\n..us = 0x%X\n", llvm_cbe__2e__2e_us);
if (AESL_DEBUG_TRACE)
printf("\n  %%.storemerge34.us = select i1 %%or.cond8.us, i20 0, i20 %%storemerge349.us, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe__2e_storemerge34_2e_us_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE)
printf("\n  %%63 = getelementptr inbounds i20* %%orig_out, i64 %%51, !dbg !7 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_240_count);
  llvm_cbe_tmp__43 = (signed int *)(&llvm_cbe_orig_out[(((signed long long )llvm_cbe_tmp__38))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__38));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i20 %%storemerge3, i20* %%63, align 4, !dbg !7 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_241_count);
  *llvm_cbe_tmp__43 = ((llvm_cbe_storemerge3) & 1048575ull);
if (AESL_DEBUG_TRACE)
printf("\nstoremerge3 = 0x%X\n", llvm_cbe_storemerge3);
if (AESL_DEBUG_TRACE)
printf("\n  %%64 = add nsw i32 %%storemerge10, 1, !dbg !9 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_242_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = or i1 %%55, %%56, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = add nsw i32 %%storemerge10, -2, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_157_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = sext i32 %%26 to i64, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_158_count);
  llvm_cbe_tmp__16 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = getelementptr inbounds i8* %%score_in, i64 %%27, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_159_count);
  llvm_cbe_tmp__17 = ( char *)(&llvm_cbe_score_in[(((signed long long )llvm_cbe_tmp__16))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__16));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = load i8* %%28, align 1, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_160_count);
  llvm_cbe_tmp__18 = (unsigned char )*llvm_cbe_tmp__17;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add nsw i32 %%storemerge10, -1, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_167_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = sext i32 %%30 to i64, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_168_count);
  llvm_cbe_tmp__20 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = getelementptr inbounds i8* %%score_in, i64 %%31, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_169_count);
  llvm_cbe_tmp__21 = ( char *)(&llvm_cbe_score_in[(((signed long long )llvm_cbe_tmp__20))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__20));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = load i8* %%32, align 1, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_170_count);
  llvm_cbe_tmp__22 = (unsigned char )*llvm_cbe_tmp__21;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = add nsw i32 %%storemerge10, -2, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_173_count);
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = add nsw i32 %%storemerge10, -1, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_180_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = getelementptr inbounds i8* %%score_in, i64 %%40, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_182_count);
  llvm_cbe_tmp__29 = ( char *)(&llvm_cbe_score_in[(((signed long long )llvm_cbe_tmp__28))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__28));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = load i8* %%41, align 1, !dbg !5 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_183_count);
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond8 = or i1 %%58, %%59, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_or_2e_cond8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%or.cond8, i8 %%phitmp11, i8 %%phitmp, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (unsigned char )((llvm_cbe_or_2e_cond8) ? ((unsigned char )llvm_cbe_phitmp11) : ((unsigned char )llvm_cbe_phitmp));
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%.storemerge34 = select i1 %%or.cond8, i20 %%49, i20 %%storemerge349, !dbg !11 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe__2e_storemerge34_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%.lcssa, i8* %%final_score_out, align 1, !dbg !7 for 0x%I64xth hint within @doRow  --> \n", ++aesl_llvm_cbe_264_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [100 x i8]* %%score1, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_292_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [100 x i8]* %%score2, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_293_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [100 x i20]* %%orig1, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_294_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [100 x i20]* %%orig2, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_295_count);
...
llvm_cbe_tmp__75:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 1, %%0 ], [ %%26, %%5  for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = phi i20 [ 0, %%0 ], [ %%25, %%5  for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_297_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = phi i32 [ -100, %%0 ], [ %%24, %%5  for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_298_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = add i32 %%storemerge2, -1, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_299_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = zext i32 %%8 to i64, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_300_count);
  llvm_cbe_tmp__59 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__58&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__59);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds i2* %%ref_genome, i64 %%9, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_301_count);
  llvm_cbe_tmp__60 = ( char *)(&llvm_cbe_ref_genome[(((signed long long )llvm_cbe_tmp__59))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__59));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load i2* %%10, align 1, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_302_count);
  llvm_cbe_tmp__61 = (unsigned char )*llvm_cbe_tmp__60;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__61);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call zeroext i20 @doRow(i32 %%storemerge2, i2* %%read, i2 zeroext %%11, i8* %%1, i8* %%2, i20* %%3, i20* %%4, i8* %%score_out1), !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_303_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load i8* %%score_out1, align 1, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_314_count);
  llvm_cbe_tmp__63 = (unsigned char )*(&llvm_cbe_score_out1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__63);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = sext i8 %%13 to i32, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_315_count);
  llvm_cbe_tmp__64 = (unsigned int )((signed int )( char )llvm_cbe_tmp__63);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__64);
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%15, i32 %%14, i32 %%7, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe__2e__count);
...
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%.1 = select i1 %%15, i20 %%12, i20 %%6, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe__2e_1_count);
...
printf("\n.1 = 0x%X\n", llvm_cbe__2e_1);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = add i32 %%storemerge2, 1, !dbg !8 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_320_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = zext i32 %%storemerge2 to i64, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_329_count);
  llvm_cbe_tmp__66 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_storemerge2&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__66);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds i2* %%ref_genome, i64 %%17, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_330_count);
  llvm_cbe_tmp__67 = ( char *)(&llvm_cbe_ref_genome[(((signed long long )llvm_cbe_tmp__66))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__66));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i2* %%18, align 1, !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_331_count);
  llvm_cbe_tmp__68 = (unsigned char )*llvm_cbe_tmp__67;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__68);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = call zeroext i20 @doRow(i32 %%16, i2* %%read, i2 zeroext %%19, i8* %%2, i8* %%1, i20* %%4, i20* %%3, i8* %%score_out2), !dbg !5 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_332_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i8* %%score_out2, align 1, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_341_count);
  llvm_cbe_tmp__70 = (unsigned char )*(&llvm_cbe_score_out2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__70);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = sext i8 %%21 to i32, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_342_count);
  llvm_cbe_tmp__71 = (unsigned int )((signed int )( char )llvm_cbe_tmp__70);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__71);
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = select i1 %%23, i32 %%22, i32 %%., !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_350_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__72);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = select i1 %%23, i20 %%20, i20 %%.1, !dbg !7 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_352_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__73);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = add i32 %%storemerge2, 2, !dbg !8 for 0x%I64xth hint within @AESL_ORIG_DUT_needlemanWunsch  --> \n", ++aesl_llvm_cbe_354_count);
