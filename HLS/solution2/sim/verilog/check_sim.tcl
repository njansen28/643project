...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.needlemanWunsch.autotvin_read_r.dat"
         "c.needlemanWunsch.autotvin_ref_genome.dat"
         "c.needlemanWunsch.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.needlemanWunsch.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
