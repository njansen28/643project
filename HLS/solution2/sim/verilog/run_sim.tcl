...
if {[file isfile needlemanWunsch.autotvin.dat]} {
    file delete -force needlemanWunsch.autotvin.dat
}
if {[file isfile needlemanWunsch.autotvout.dat]} {
    file delete -force needlemanWunsch.autotvout.dat
}
